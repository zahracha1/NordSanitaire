...
import photo10 from "../imgs/plom1.jpg";
import photo12 from "../imgs/plom22.jpg";
import photo16 from "../imgs/plom33.jpg";

import photo100 from "../imgs/pl11.jpeg";
import photo120 from "../imgs/pl22.jpg";
import photo160 from "../imgs/pl33.jpg";

import photo1 from "../imgs/pl44.webp";
import photo2 from "../imgs/pl5.jpg";
import photo3 from "../imgs/pl6.jpg";
    ...
    <>
      ...
      >
        ...
        <h3 data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
          Propose une large gamme de services de Plomberie, allant des travaux{" "}
      ...
      <div className="cont">
        <p data-aos="fade-up" data-aos-duration="2000" data-aos-once="true">
          {" "}
          Notre équipes de professionnels qualifiés sont prêtes à intervenir
          rapidement et efficacement pour résoudre tous vos problèmes de
          plomberie. Que ce soit pour des réparations urgentes, des
          remplacements de composants ou des projets d'installation complexes,
          nous sommes en mesure de vous offrir des solutions adaptées à vos{" "}
          <br></br> besoins spécifiques.
        </p>
      </div>
